...
Ten pakiet zawiera implementację devlabel. Umożliwia spójne montowanie
urządzeń. Osiąga to poprzez oznaczanie unikalnymi identyfikatorami
każdej kombinacji urządzenie/symlink i potwierdzanie, że dany
identyfikator nadal pasuje do nazwy urządzenia przed umożliwieniem
odwzorowania dowiązania symbolicznego.
